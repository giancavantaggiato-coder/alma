import svgPaths from "./svg-vjfu3kmblr";
...
export default function Testimonial() {
  return (
    <div className="bg-[#fefbf3] content-stretch flex flex-col items-center px-[64px] py-[112px] relative size-full" data-name="Testimonial / 6 /">
      <Container />
    </div>
  );
}